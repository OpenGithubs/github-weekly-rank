...
- 榜单排名：第1名
    ...
    - 开源Stars：41622⭐
    - 周Star增长量：28851⭐
    - 项目描述： 特斯拉首席执行官（CEO）马斯克的AI创企xAI正式发布3140亿参数的混合专家模型Grok-1。xAI官方网站称，其遵照Apache 2.0协议开放模型权重和架构。
...
|------------|------------|---------------|---------------- |--------------|----------------|------------|------------|------------|
| 🥇 | <img src="https://avatars.githubusercontent.com/u/130314967?v=4" alt="" size="32" height="32" width="32" data-view-component="true" class="avatar circle"> | [xai-org/grok-1](https://github.com/xai-org/grok-1)| 41.6k | 🔺28851 | 🔺0% | 🔺2037 | 2024-03-17 | 特斯拉首席执行官（CEO）马斯克的AI创企xAI正式发布3140亿参数的混合专家模型Grok-1。xAI官方网站称，其遵照Apache 2.0协议开放模型权重和架构。  |
